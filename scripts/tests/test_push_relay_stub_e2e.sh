...
CENT_PROXY="$(secret)"
PROVIDER_KEY="$(secret)"
# #2066 — api·webhook-sender 가 `${VAR:?}` 로 요구한다.
WEBHOOK_INGRESS_KEY="$(secret)"
WEBHOOK_OUTBOUND_KEY="$(secret)"
...
WEBHOOK_INGRESS_MASTER_KEY=$WEBHOOK_INGRESS_KEY
OUTBOUND_WEBHOOK_MASTER_KEY=$WEBHOOK_OUTBOUND_KEY
