...
require(components == ["api", "relay", "worker", "migrate"], "matrix must contain four ordered runtime images")
for image in ("momo-server", "momo-outbox-relay", "momo-agent-worker", "momo-migrate"):
...
for variable in ("MOMO_API_IMAGE", "MOMO_RELAY_IMAGE", "MOMO_WORKER_IMAGE", "MOMO_MIGRATE_IMAGE"):
