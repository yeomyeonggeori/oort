...
is_sensitive_key() {
  case "$1" in
    *PASSWORD*|*HMAC*|*API_KEY*|*TOKEN*|*SECRET*|*CIPHER_PASS*|DATABASE_URL|RELAY_DATABASE_URL|WORKER_DATABASE_URL|MOMO_APP_DATABASE_URL|MIGRATE_DATABASE_URL|OUTBOUND_WEBHOOK_MASTER_KEY|CENTRIFUGO_REDIS_ADDRESS|HERMES_BASE_URL)
      return 0
      ;;
    *)
      return 1
