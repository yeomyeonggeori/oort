...
MOMO_IMAGE=ghcr.io/yeomyeonggeori/oort@sha256:$DIGEST_A
MOMO_API_IMAGE=ghcr.io/yeomyeonggeori/oort@sha256:$DIGEST_A
MOMO_RELAY_IMAGE=ghcr.io/yeomyeonggeori/oort@sha256:$DIGEST_A
MOMO_WORKER_IMAGE=ghcr.io/yeomyeonggeori/oort@sha256:$DIGEST_A
MOMO_MIGRATE_IMAGE=ghcr.io/yeomyeonggeori/oort@sha256:$DIGEST_A
MOMO_WEB_IMAGE=ghcr.io/yeomyeonggeori/oort@sha256:$DIGEST_A
MOMO_LINKSHORT_IMAGE=ghcr.io/yeomyeonggeori/oort@sha256:$DIGEST_A
POSTGRES_DB=momo
POSTGRES_USER=momo
...
MOMO_IMAGE=ghcr.io/yeomyeonggeori/oort@sha256:$OLD_A
MOMO_API_IMAGE=ghcr.io/yeomyeonggeori/oort@sha256:$OLD_A
MOMO_RELAY_IMAGE=ghcr.io/yeomyeonggeori/oort@sha256:$OLD_A
MOMO_WORKER_IMAGE=ghcr.io/yeomyeonggeori/oort@sha256:$OLD_A
MOMO_MIGRATE_IMAGE=ghcr.io/yeomyeonggeori/oort@sha256:$OLD_A
MOMO_WEB_IMAGE=ghcr.io/yeomyeonggeori/oort@sha256:$OLD_A
MOMO_LINKSHORT_IMAGE=ghcr.io/yeomyeonggeori/oort@sha256:$OLD_A
EOF
...
sed -E "/^MOMO_(IMAGE|API_IMAGE|RELAY_IMAGE|WORKER_IMAGE|MIGRATE_IMAGE|WEB_IMAGE|LINKSHORT_IMAGE)=/s|=.*|=ghcr.io/yeomyeonggeori/oort:\${MOMO_IMAGE_TAG}|" \
  "$ENV_FILE" > "$TAG_ENV"
...
grep -Fq -- '--repo yeomyeonggeori/oort --predicate-type https://slsa.dev/provenance/v1' "$GH_TRACE" ||
...
if PATH="$FAKE_BIN:$PATH" MOMO406_DOCKER_TRACE="$TRACE" \
  MOMO406_FAIL_NEW_API_ONCE=1 MOMO406_NEW_API_IMAGE="ghcr.io/yeomyeonggeori/oort@sha256:$DIGEST_A" \
...
grep -Fq "api_image=ghcr.io/yeomyeonggeori/oort@sha256:$OLD_A args=" "$TRACE" ||
