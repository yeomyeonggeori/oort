...
auto_classify_script() {
  ...
  case "$1" in
    ...
    scripts/check_docs_commands.py|scripts/tests/test_docs_commands_gate.sh)
      ...
      # (RUN.md, the runbooks, AGENTS.md) are docs-lane files anyway.
...
add_static_commands() {
  ...
  # #1525: RUN.md, the runbooks and AGENTS.md are executed verbatim — AGENTS.md
