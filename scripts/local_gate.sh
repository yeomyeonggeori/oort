...
add_runtime_db_commands() {
  ...
  add_note_once coverage "Docker compose, migration idempotency, RLS tenant isolation via scripts/verify_rls.sh, and public /v1/join invite self-signup via scripts/verify_join.sh."
}
