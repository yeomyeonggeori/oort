...
API_PORT="${THREAD_PROJECTION_API_PORT:-27890}"
CENT_PORT_HOST="${THREAD_PROJECTION_CENTRIFUGO_PORT:-27891}"
PG_PORT="${THREAD_PROJECTION_POSTGRES_PORT:-27892}"
HERMES_PORT_HOST="${THREAD_PROJECTION_HERMES_PORT:-27893}"
