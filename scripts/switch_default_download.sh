...
base = "https://github.com/Dawn-kim-official/momo-alpha/releases/download"
...
echo "  verify: https://dawn-kim-official.github.io/momo-alpha/update-manifest-alpha.json"
