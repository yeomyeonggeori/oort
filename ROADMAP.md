...
- **UX 즉시 체인:** MOMO-383 workspace-first sidebar/header/menu + ADR-0118 active-member read/owner-admin rename(**리뷰 반려 수정·전체 Swift 345 tests 완료, clean gate 진행 중**) → MOMO-384 native channel creation sheet + window-level tooltip → MOMO-385 member inspector + one-click DM → MOMO-386 RLS workspace search + result jump.
