...
| `MOMO-245` | M1/M7 준비 | Local Soak/Resource Monitor | 72h local dogfood 중 health, outbox, relay/worker, Docker resource, app/runtime 상태를 repo 밖 evidence로 남기는 lightweight monitor |
