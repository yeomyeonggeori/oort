...
| `MOMO-193` | M3 | SwiftCentrifuge RealtimeSubscriptionDriver v0 | `MomoCore` realtime driver/replay controller + macOS REST backend injection seam; duplicate/gap/backfill tests pass; actual SwiftCentrifuge adapter/token endpoint remains runtime-unverified |
