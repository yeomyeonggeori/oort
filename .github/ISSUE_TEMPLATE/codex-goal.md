...
> 작성 규칙: 추론으로 못 얻는 것만 적는다. 검증 등급(`[swift]/[infra]/[sql]/[python]/[runtime]`)을 Acceptance에 반드시 명시.

## Goal
<!-- 한 문장. "무엇을 done 상태로 만드는가". 예: server에 channel_seq 발급 트랜잭션 라우트를 추가하고 swift build green. -->
...
<!-- AGENTS.md §2~3의 등급으로. 닫으려면 전부 충족. -->
