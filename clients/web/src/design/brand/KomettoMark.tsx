...
//   혜성 꼬리는 후드색 → 호박 → 살구 세 띠다(후드 원 중심의 동심원, 단단한 멈춤점).
//
...
const GEOMETRY = {
  viewBox: "-11 -9 84 84",
  comet: "M53.17 23.98C62.07 48.41 67.59 61.06 72.5 64.5C52.69 61.72 52.08 50.39 36.32 53.17Z",
...
export function KomettoMark({ className, title }: { className?: string; title?: string }) {
  ...
  const [cx, cy, r] = GEOMETRY.cometRadial;
  ...
  return (
    ...
    >
      <defs>
        <radialGradient id={gradient} gradientUnits="userSpaceOnUse" cx={cx} cy={cy} r={r}>
