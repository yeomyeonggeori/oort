...
//
// 기하가 두 벌이다.
//   small   — 24 격자, 16~32px 광학 보정판(틈·위성·구멍을 키웠다). 기본값.
//             사이드바·로그인 락업처럼 size-4·size-6 자리.
//   display — 64 격자 정본. 온보딩 S0처럼 큰 자리. small을 크게 키우면 틈이
//             두꺼워 보인다.
//
// 색은 `currentColor` 하나다. 라이트/다크 두 벌을 두지 않고 부모가 정한 잉크를
// 물려받으므로, 사이드바에서는 --accent, 비활성 자리에서는 --ink-muted가
// 그대로 걸린다(tokens.css가 유일한 색 출처). 앱 아이콘의 두 색(오프화이트 링,
// 호박 위성)은 런처·탭 자산에만 쓴다.
//
// tokens.css `.onboarding-mark svg path:nth-of-type(2)`가 두 번째 path(위성)에
// 묶여 있으므로 순서를 바꾸지 않는다.
// =============================================================================
...
const GEOMETRY = {
  small: {
    viewBox: "0 0 24 24",
    ring: "M18.59 10.46A8 8 0 0 1 7.29 20.09A0.5 0.5 0 0 0 6.94 20.04L4.2 20.71A0.75 0.75 0 0 1 3.29 19.8L3.96 17.06A0.5 0.5 0 0 0 3.91 16.71A8 8 0 0 1 13.54 5.41A4.5 4.5 0 0 0 18.59 10.46ZM15 13A4 4 0 1 0 7 13A4 4 0 1 0 15 13Z",
