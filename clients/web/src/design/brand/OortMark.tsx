...
//             두꺼워 보인다. 온보딩 S0의 큰 로고는 #2732부터 KomettoMark(코메토
//             얼굴)다. 그 얼굴 창의 림은 이 링과 같은 문법(링 + 말풍선 꼬리)이다.
//
...
// 호박 위성)은 탭 자산에만 쓴다.
//
// 락업(size-6, 24px)은 코메토 얼굴로 바꾸지 않는다. 32px 미만에서는 얼굴의
// 눈과 말풍선 꼬리가 뭉개지고(docs/brand/mark/README.md 「작은 크기」), 락업은
