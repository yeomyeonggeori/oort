...
export function menuRowClass({
  ...
  return cn(
    "tap-target flex cursor-default select-none gap-2 rounded-sm px-2 text-body outline-none press press-instant-fill focus:bg-surface-hover focus-visible:focus-ring data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
    layout === "stack"
