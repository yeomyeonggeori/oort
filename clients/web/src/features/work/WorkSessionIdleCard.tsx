...
export function WorkSessionIdleCard({
  ...
  return (
    <button
      ...
      className="mt-1 flex w-full max-w-pane-lg flex-col rounded-md border border-line bg-surface-raised text-left hover:bg-surface-hover active:bg-surface-pressed focus-visible:focus-ring disabled:opacity-50"
    >
