...
export function WorkSessionIdleCard({
  ...
  return (
    <button
      ...
      className="mt-1 flex w-full max-w-pane-lg flex-col rounded-md border border-line bg-surface-raised text-left press hover:bg-surface-hover focus-visible:focus-ring disabled:opacity-50"
    >
