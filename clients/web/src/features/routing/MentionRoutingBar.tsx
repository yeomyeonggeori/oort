...
function RowAction({
  ...
  return (
    <button
      ...
      data-testid={testId}
      className="flex shrink-0 items-center gap-1 rounded-sm text-meta text-ink-muted underline underline-offset-2 press hover:text-ink focus-visible:focus-ring"
    >
      {children}
    </button>
  );
