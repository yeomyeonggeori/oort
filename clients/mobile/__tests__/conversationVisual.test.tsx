...
//
// 그리고 손댔다: #1155 가 폰 다크의 accent 가족을 웹 다크 항(#f0a850)으로 정렬했다.
// 이름으로 대응했더라면 그날 이 경계가 파랑에서 호박으로 **뜻 없이** 옮겨갔을
// 것이다. 역할로 대응했으므로 아래 단정은 한 줄도 고치지 않았고 값도 `warn`
// 그대로다 — 그것이 이 설계가 실제로 산 것이다.
//
