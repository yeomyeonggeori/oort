 ...
 * 갈아탄다**: 에이전트가 라이트에서는 새벽 남색(`--agent` #4a6785)이고 다크에서는
 * 네온 보라(#b58bd6)였다 — 두 값의 색상각이 159° 벌어져 있었고, 그것은 한 아이덴티티
 * 의 두 스킴이 아니라 두 아이덴티티다. 웹 정본이 그 색을 두고 적어 둔 규율이
...
export const darkPalette: Palette = {
  ...
  onAccent: '#17161a',
  // 네온 보라(#b58bd6)였다 (#1164). 라이트의 `--agent`(#4a6785)와 색상각이 159°
  // 벌어져 있었으므로 스킴 전환이 에이전트를 **다른 인물**로 만들었다.
  agent: '#7fa0c4',
  agentSurface: '#1e2836',
  warn: '#d4a72c',
  warnSurface: '#292415',
