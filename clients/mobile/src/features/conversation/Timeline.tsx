...
function TimelineInner({
  ...
  //
  // 잰 결과(같은 기기·빌드, 바닥에서 읽는 중에 답 여섯이 250·500ms 간격): 수리 전은 12줄
  // 1712.3pt 모자람·필, 4줄 41.3pt, 3줄 21.0pt(셋째 줄 가림). 수리 뒤는 12·4·3줄 18회
  // 모두 끝(0.0)에 앉았고 따라가기가 한 번도 풀리지 않았으며 필 0, 빈 표본 0 이다.
  //
