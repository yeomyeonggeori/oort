...
pub use work_control::{
    active_host_owner_in_tx, agent_control_allowed, agent_owner_human_in_tx,
    apply_spawn_approval_decision_in_tx, bind_control_approval_message_in_tx,
    bind_control_session_in_tx, control_event_payload, control_run_binding_in_tx,
    default_spawn_host, disable_auto_approve_in_tx, dispatched_spawn_owner_in_tx,
    ...
    record_host_last_used_in_tx, remote_host_owner_in_tx, remote_host_refuses_tool_in_tx,
    resume_target_rejection_in_tx, retarget_control_host_in_tx,
    ...
    HOST_SCOPE_MEMBER, KIND_INPUT, KIND_KILL, KIND_READ, KIND_SPAWN, REFUSAL_REMOTE_HOST_KILL_ONLY,
    REFUSAL_REMOTE_HOST_OWNER_REQUIRED, REFUSAL_REMOTE_HOST_SHELL, SHELL_LAUNCH_COMMANDS,
    STATUS_ACKED, STATUS_APPROVED, STATUS_DENIED, STATUS_DISPATCHED, STATUS_FAILED,
    STATUS_PENDING_APPROVAL, T3_SPAWN_ENABLED, TOOL_SHELL,
};
