...
pub use work_control::{
    ...
    dispatched_spawn_owner_in_tx, enable_auto_approve_in_tx, fail_approved_control_in_tx,
    fetch_work_control_in_tx, host_tier, insert_work_control_in_tx, last_used_spawn_host_in_tx,
    list_auto_approvals_in_tx, lock_work_control_in_tx, mark_control_dispatched_in_tx,
    pending_controls_for_host_in_tx, record_host_last_used_in_tx, resume_target_rejection_in_tx,
    retarget_control_host_in_tx, session_control_lineage_status_in_tx, settle_control_ack_in_tx,
