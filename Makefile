...
# Swift 패키지 루트 (의존 순서: Core → server/relay/worker/notifier → macOS)
SWIFT_PKGS := clients/Core server relay/OutboxRelay workers/AgentWorker workers/NotifierWorker clients/macOS
