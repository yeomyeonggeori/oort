...
| [`research/11-agent-runtime/15-m3-dbc-real-data-readiness.md`](../research/11-agent-runtime/15-m3-dbc-real-data-readiness.md) | M3 D/B/C real-data readiness 정본(MOMO-020/021/022 unblock 조건, endpoints/events, local gate, follow-up MOMO-199~203 후보) |
