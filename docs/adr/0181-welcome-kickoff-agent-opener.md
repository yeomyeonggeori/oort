...
## 증보 (2026-09-26, ADR-0193 D5 · #2817)

- **D7 순서 대체.** D7의 「스테이지 exit → 오프너 arrival」 순서는 ADR-0193/온보딩 2.0 D5 띠 구조로 대체된다. 띠가 타임라인 밖(컴포저 위)에 있어 오프너와 기쁨 띠가 함께 선다. 보류 장치(`holdEntranceId`, `pinArrivalGrant`)를 제거했다(planner 판정 2026-09-26).
