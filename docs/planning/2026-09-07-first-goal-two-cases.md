...
> **2026-09-23 대체:** 1차 목표 정의(G1')는 ADR-0187 D1(목표 A — 팀 일상 사용 먼저)이 대체한다. 아래 두 설치 케이스는 외부 출시 단계에서 다시 쓰는 역사 기록이다.
...
## 9. 2026-09-08 저녁 결재 (성재)
ADR-0004 증보 Accept(케이스 B 본인 hermes 합류 경계 열림) · G1'-3 SH-8(#2230)·SH-9(#2231) 발급 go(범위 정정: SH-8=§3.3.16 검수·보강+로컬 CDP 하네스 신규+#1361 해제 준비, SH-9=런북 국소 재작성+SELF_HOST §5 로컬 provider 절) · Railway 실배포 E2E는 최종 검증 단계 · 실기기 APNs는 데스크톱 셀프호스팅 완료 뒤.
