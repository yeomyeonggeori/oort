...
|---|---|---|---|---|---|
| LS-0 게이트 재배선(정책 감사 1회) | **#2142** | `handoffs/2026-09-07-ls0-gate-rewire-brief.md` | engine | L | **완료**(main `6ed61cfb`) |
...
## 4. 출시 잔여 재편성 — **확정본은 `2026-09-07-first-goal-two-cases.md` §4** (성재 2026-09-07 오후 지시로 두 케이스 기준 재편성; 이 절의 초안은 그 문서로 대체됨)

## 5. 질문 3건 — **결정됨** (`2026-09-07-first-goal-two-cases.md` §5)
1. 재편성 확정(팔레트·DS-1 잔여·R2d·허들·TURN은 ITO 뒤). 2. work 표면은 LS-2에서 셀프호스트 기본 플래그 off로 숨김(라우트 유지). 3. G3 문서는 LS-3에서 삭제, `docs/external-agent-provider/*`는 삭제 금지(hermes 합류 런북 재작성 대상 SH-9).
