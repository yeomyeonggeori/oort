...
- **잔여 후보**: SH-12b-w R3→design-review R3 → SH-12e · SH-11d 랜딩 · #2328·#2347·#2356 · A6 R3 · v0.1.5 발행(노트 초안 `claudedocs/release-v0.1.5-notes-draft.md`; S1·S2 랜딩 뒤 성재 dispatch) · 제로베이스 온보딩 E2E 재실측(A·B) · SH-11a Railway 실배포(최종) · APNs(데스크톱 뒤) · #2262 M-1·M-2·N3 · 캡처 레인 게이트 · D4 · #2157·#2181·#2193.
