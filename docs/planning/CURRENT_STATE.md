...
> **다음 세션 진입점: `docs/planning/handoffs/2026-07-26-next-batch-handoff.md`** — 파이프라인이 Fable 오케스트레이션 + Codex `gpt-5.6-terra` high 워커로 전환됨(codex-fleet 계약). 성재 결정 대기 3건(ADR-0137 Accept / C1·C2 main 동기화+next.10 / MOMO-631 iOS 전송 400), 착수 가능 티켓 5장(#825·826·827·828·831) 핸드오프 패킷 포함.
