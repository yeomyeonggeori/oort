...
| `ADR-0123` | iOS 클라이언트 v0 — dogfood-first 모바일 수신부 (성재 발제 2026-07-17) | Fable | **`accepted`** (2026-07-17) | 성재 ✓ | IOS-1(MOMO-462 `#474`)부터 순차 실행 — 구현=codex iOS 플러그인, ios 게이트=오케스트레이터 |
