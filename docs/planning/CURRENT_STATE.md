...
| **ADR-0119 웹 첫 배치** | `2026-07-15-adr-0119-web-track.md` | MOMO-389 `#395` → MOMO-390 `#396` → MOMO-391 `#397` | **배치 종결** — 389 `6fe746f` · 390 `5ecd645` · 391 `63e7d51`(main `web` 게이트 PASS) | **웹 v0 완주 + 푸시 서버측 완성** — 403 `36c0d70`·404 `a8a1089`(**ADR-0120 P-1/P-2 종결**). 잔여: P-3 relay 실발송(Dawn 운영 결정)·P-4(iOS/M5). ADR-0122 승인·플러그인(16-02) 위임 대기 |
