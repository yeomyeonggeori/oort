...
| **ADR-0119 웹 첫 배치** | `2026-07-15-adr-0119-web-track.md` | MOMO-389 `#395` / MOMO-390 `#396` → MOMO-391 `#397` | `ready` (389/390 ready, 391 blocked) | 389·390 병렬 → 391. 오케스트레이션: Fable(엔진/인프라 트랙 겸임) |
