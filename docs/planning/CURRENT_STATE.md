...
| W1 팀 인스턴스 | #2205 설정 PR 워커 진행(시작 명령·PG18+pgvector·Centrifugo 이름·XFP·드라이브·푸시 서비스·doctor 수리). v0.1.6 발행 워크플로 dispatch(성재 release 승인 대기) | 설정 PR 랜딩 + v0.1.6 → `oort-team` 배포(워커 단계 2) |
...
| 작업 / owner | 저장된 결과 | 다음 |
|---|---|---|
| #2565 정책 PR #2566 / planner | ADR-0187·M7 두 등급·절차 개정. 리뷰어 C R1·R2 FAIL → 수리, 2차 결재 반영 | R3 → 정책 감사 → track/engine |
