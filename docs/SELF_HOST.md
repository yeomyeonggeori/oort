...
address. This server refuses loopback addresses
(`http://127.0.0.1:...`, `localhost`) by default. **Settings → AI link**
then shows what happened and what to do. Allowing a local provider is a
server-operator self-host setting, not a client switch.
