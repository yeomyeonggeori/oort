...
| `MOMO-199` | macOS SwiftCentrifuge live adapter | swift/macos-ui/runtime-relay | MOMO-192, MOMO-193 |
| `MOMO-200` | D Live Tool-Call fixture/local gate | runtime-agent/macos-ui | MOMO-199, MOMO-178 |
| `MOMO-201` | B Cost projection + CostSnapshot binding | swift/runtime-agent/macos-ui | MOMO-004, MOMO-170 |
| `MOMO-202` | C Approval pending projection + inbox real-data gate | swift/runtime-db/macos-ui | MOMO-167, MOMO-171 |
| `MOMO-203` | M3 D/B/C combined local gate profile | docs/swift/runtime-agent/macos-ui | MOMO-199, MOMO-200, MOMO-201, MOMO-202 |
...
### MOMO-200 수용기준 `[runtime-agent/macos-ui]`
...
### MOMO-201 수용기준 `[swift/runtime-agent/macos-ui]`
...
### MOMO-202 수용기준 `[swift/runtime-db/macos-ui]`
...
### MOMO-203 수용기준 `[docs/swift/runtime-agent/macos-ui]`
