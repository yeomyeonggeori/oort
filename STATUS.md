...
- 검증: `scripts/tests/test_oort_day2.sh` 16 · `test_oort_doctor.sh` 18 · check id 32==T1 · dump >0바이트 · TOC T1=T2. 이미지 `/opt/momo/scripts/oort`. 호스트 `pg_dump` 18.4 vs 픽스처 PG18.
